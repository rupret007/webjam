...
contains the **v0.12.0 test-night candidate**, built from
`796e9a4ddebe79f430b0ded8cf8034bc27836dd0`. The exact private Apple-Silicon
ZIP includes the sound-confirmation screen, CoreAudio route preflight,
recording-storage guard, and recording-provenance journal. Its ordinary
musician path remains the proven v1/v2 same-LAN flow;
