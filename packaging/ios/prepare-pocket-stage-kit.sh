...
required_files=(
  ...
  "PocketStage/Assets.xcassets/Contents.json"
  "PocketStage/Assets.xcassets/AppIcon.appiconset/Contents.json"
  "PocketStage/Assets.xcassets/AppIcon.appiconset/AppIcon-1024.png"
  "PocketStage/Assets.xcassets/WebJamMark.imageset/Contents.json"
