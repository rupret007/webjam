...
class TakeDeck(QDialog):
    ...
    def _build_ui(self) -> None:
        ...
        # Left: take list
        left = QVBoxLayout()
        takes_header = QLabel("Takes")
        takes_header.setObjectName("CanvasHeader")
        left.addWidget(takes_header)
        self._take_list = QListWidget()
        self._take_list.setObjectName("TakeList")
        ...
        self._reload_btn.setObjectName("GhostButton")
