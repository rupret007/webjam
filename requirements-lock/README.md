...
The immutable v0.25.0 private test release retains the exact dependency locks
reviewed for v0.24.0 and binds them to its exact tag CI artifacts and checksum
manifest. A source checkout remains metadata, not a published package claim.
