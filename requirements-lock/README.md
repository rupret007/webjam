...
CPython 3.11.15 on Linux, pip 26.1.2, and setuptools 83.0.0. Regenerate all
locks with uv 0.11.29 after a deliberate dependency change, then rerun the
entire native matrix before creating a release tag:
