...
| “Why will my Reference Track not play?” | Source loading and playback permission are separate. Downloaded v0.22.2 locks Play before route scanning. Published v0.22.3 enables it only after WebJam proves the isolated local BlackHole route; installing BlackHole, running setup, or choosing **Recheck Route** never bypasses that proof. Loading still validates the file and decodes its first bounded block. |
