...
## macOS host + musician workstation (v0.10.0 pilot)
...
One-click in-app hosting is macOS-only in the v0.10.0 private pilot.
...
The remote musician does not receive the recorder secret. Tonight's v0.10.0
...
is **not** the v0.10.0 test-night validation path; that path uses the prepared
...
advanced source/developer topology; the v0.10.0 Join screen intentionally
