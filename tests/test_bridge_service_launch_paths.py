...
def _make_bridge():
    ...
    # Exercise the approved v0.28.2 baked-component boundary. The sealed
...
class TestFindJamulusFallback(unittest.TestCase):
    def test_v0281_source_resolves_the_bundled_client(self):
        bridge = _make_bridge()
        ...
        with patch("core.settings.AppSettings", return_value=default_settings), patch(
            ...
            self.assertEqual(bridge._runtime_webjam_version(), "0.28.2")
            self.assertEqual(
