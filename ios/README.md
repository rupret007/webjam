...
> **v0.25.0 private test release:** these setup instructions describe the kit
> included with exact checksum-verified v0.25.0 Mac assets. Immutable v0.25.0 is
...
1. Install the full **Xcode** app from Apple and open it once. In **Xcode →
   ...
   Team.
2. From a matching, checksum-verified v0.25.0 Mac candidate, open **Pocket Stage iPhone
